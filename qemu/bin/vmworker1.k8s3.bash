...
g_vdisk_path="/dt2/vdisks/${g_vm_name}_1.qcow2"

# > Para generar la MAC se usara:
#   printf -v macaddr "52:54:%02x:%02x:%02x:%02x" $(($RANDOM & 0xff)) $(($RANDOM & 0xff)) $(($RANDOM & 0xff)) $(($RANDOM & 0xff))
#   echo $macaddr
g_mac_address='52:54:9a:3a:7b:4f'

#Constantes usados solo durante la instalación de la VM.
g_iso_os_path='/tempo/isos/Fedora-Server-dvd-x86_64-40-1.14.iso'
